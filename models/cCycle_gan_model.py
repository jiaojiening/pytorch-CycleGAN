...
class cCycleGANModel(BaseModel):
    def name(self):
        return 'cCycleGANModel'
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            # A(high-resolution) and B(low-resolution) have the same person label and attributes
            # Input1: A(high-resolution) + attribute of A,B(high-resolution and low-resolution), real
            # Input2: fake_A + attribute of A,B(high-resolution), fake
            # Input3: A(high-resolution) + random sampled attribute(not the same as attribute of A,B), fake
