...
python test_reid_SR.py --dataroot Market --name Market_reid_cyclegan_upscale_8_resnet_6blocks_stage0_lr_0.1 --dataset_mode single_Market --model test_reid_SR --gpu 3 --no_dropout --up_scale 8 --netG resnet_6blocks
