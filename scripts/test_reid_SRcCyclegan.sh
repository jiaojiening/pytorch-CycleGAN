...
python test_reid_SR.py --dataroot DukeMTMC-reID --name Duke_reid_SRcCyclegan_upscale_8_resnet_6blocks_stage0 --dataset_mode single_Duke --model test_reid_SR --gpu 5 --no_dropout --up_scale 8 --netG resnet_6blocks
...
python test_reid_SR.py --dataroot DukeMTMC-reID --name Duke_reid_hybrid_cyclegan_upscale_8_resnet_6blocks_stage0 --dataset_mode single_Duke --model test_reid_cyclegan --gpu 5 --no_dropout --up_scale 8 --netG resnet_6blocks
