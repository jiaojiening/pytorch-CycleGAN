...
python train.py --dataroot DukeMTMC-reID --name Duke_gan_upscale_8_resnet_6blocks --dataset_mode Duke --model gan --gpu 7,4 --no_dropout --up_scale 8 --netG resnet_6blocks
...
python train.py --dataroot DukeMTMC-reID --name Duke_hybrid_cCyclegan_upscale_8_resnet_6blocks --dataset_mode Duke --model hybrid_cCycle_gan --gpu 0,1,2,3 --no_dropout --up_scale 8 --netG resnet_6blocks --batch_size 32
