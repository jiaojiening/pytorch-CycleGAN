...
python test_SR.py --dataroot Market --name Market_hybrid_cyclegan_upscale_8_resnet_6blocks_v2 --dataset_mode single_Market --model test_SR --gpu 7 --no_dropout --up_scale 8 --netG resnet_6blocks
python test_SR.py --dataroot Market --name Market_hybrid_cyclegan_upscale_8_resnet_6blocks_v2 --dataset_mode Market --model test_SR --gpu 7 --no_dropout --save_phase train --up_scale 8 --netG resnet_6blocks
python test_SR.py --dataroot Market --name Market_hybrid_cyclegan_upscale_8_resnet_6blocks_rec_20 --dataset_mode single_Market --model test_SR --gpu 7 --no_dropout --up_scale 8 --netG resnet_6blocks
python test_SR.py --dataroot Market --name Market_hybrid_cyclegan_upscale_8_resnet_6blocks_rec_20 --dataset_mode Market --model test_SR --gpu 7 --no_dropout --save_phase train --up_scale 8 --netG resnet_6blocks
