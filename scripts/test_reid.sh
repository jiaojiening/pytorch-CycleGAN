...
python test_reid.py --dataroot DukeMTMC-reID --name SR_Duke_Reid_16_lr_0.01 --dataset_mode SR_Duke --model reid --gpu 0 --no_dropout --SR_name Duke_cCyclegan
python evaluate_reid.py --dataroot DukeMTMC-reID --name SR_Duke_Reid_16_lr_0.01
python test_reid.py --dataroot DukeMTMC-reID --name SRcCyclegan_Duke_Reid_16_lr_0.01 --dataset_mode SR_Duke --model reid --gpu 0 --no_dropout --SR_name Duke_SRcCyclegan
python evaluate_reid.py --dataroot DukeMTMC-reID --name SRcCyclegan_Duke_Reid_16_lr_0.01
python test_reid.py --dataroot DukeMTMC-reID --name paired_cCyclegan_Duke_Reid_16_lr_0.01 --dataset_mode SR_Duke --model reid --gpu 3 --no_dropout --SR_name Duke_paired_cCyclegan
...
python test_reid.py --dataroot DukeMTMC-reID --name SRcCyclegan_Duke_Reid_upscale_8_resnet_6blocks --dataset_mode SR_Duke --model reid --gpu 3 --no_dropout --SR_name Duke_SRcCyclegan_upscale_8_resnet_6blocks
...
python test_reid.py --dataroot Market --name Market_Reid_upscale_8 --dataset_mode single_Market --model reid --gpu 0 --no_dropout --up_scale 8
...
python test_reid.py --dataroot Market --name SRcCyclegan_Market_Reid_upscale_8_resnet_6blocks --dataset_mode SR_Market --model reid --gpu 0 --no_dropout --SR_name Market_SRcCyclegan_upscale_8_resnet_6blocks
...
python test_reid.py --dataroot Market --name cyclegan_Market_Reid_upscale_8 --dataset_mode SR_Market --model reid --gpu 0 --no_dropout --SR_name Market_cyclegan_upscale_8
