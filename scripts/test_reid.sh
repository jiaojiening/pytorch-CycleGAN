python test_reid.py --dataroot DukeMTMC-reID --name Duke_Reid_NR --dataset_mode single_Duke --model reid --phase test --gpu 1 --no_dropout --NR
...
python test_reid.py --dataroot DukeMTMC-reID --name Duke_Reid_upscale_8_GT_A --dataset_mode single_Duke --model reid --gpu 4 --no_dropout --up_scale 8
...
python test_reid.py --dataroot Market --name Market_Reid_upscale_8_GT_A --dataset_mode single_Market --model reid --gpu 4 --no_dropout --up_scale 8
