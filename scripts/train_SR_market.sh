...
python train.py --dataroot Market --name Market_hybrid_cyclegan_upscale_8_resnet_6blocks_rec_20 --dataset_mode Market --model hybrid_cycle_gan --gpu 0,1,2,3 --no_dropout --up_scale 8 --netG resnet_6blocks --batch_size 32
