...
class PairedMarketDataset(BaseDataset):
    @staticmethod
    ...
    def initialize(self, opt):
        ...
        if opt.phase == 'train':
            ...
            # -----------------------------------------
            # query (test B) LR
            self.dir_query = os.path.join(self.dataPath, self.root, 'query')  # images in the query
            ...
            # -----------------------------------------
            # gallery (test A) HR
            self.dir_gallery = os.path.join(self.dataPath, self.root, 'bounding_box_test')
    ...
    def __getitem__(self, index):
        ...
        assert A_real_attr == B_real_attr, 'A_real_attr must be equal to B_real_attr'
